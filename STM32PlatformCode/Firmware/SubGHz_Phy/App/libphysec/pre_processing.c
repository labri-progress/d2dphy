...
int pre_process_random_waypoint_model(csi_t *csis, size_t num_csi) {
    ...
    // TODO: Performs curve fitting on K and Omega factors and calculate C and D coefficients

    // TODO: Coefficients modification: SC = \frac{n}{0.2 * l} (where n is coef index and l is the length of C and D sets)
