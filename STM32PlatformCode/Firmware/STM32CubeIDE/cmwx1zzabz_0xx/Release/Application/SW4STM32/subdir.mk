...
Application/SW4STM32/startup_stm32l072xx.o: $(PROJECT_ROOT)/STM32PlatformCode/Firmware/STM32CubeIDE/startup_stm32l072xx.s Application/SW4STM32/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m0plus -c -I"$(PROJECT_ROOT)/STM32PlatformCode/Firmware/STM32CubeIDE/cmwx1zzabz_0xx/libphysec" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
