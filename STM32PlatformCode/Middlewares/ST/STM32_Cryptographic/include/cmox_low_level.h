 ...
 * @param          pArg User defined parameter that is transmitted from
 * Initialize service
 * @retval         Initialization status: @ref CMOX_INIT_SUCCESS / @ref
 * CMOX_INIT_FAIL
 */
 ...
 * @param          pArg User defined parameter that is transmitted from Finalize
 * service
 * @retval         De-initialization status: @ref CMOX_INIT_SUCCESS / @ref
 * CMOX_INIT_FAIL
 */
